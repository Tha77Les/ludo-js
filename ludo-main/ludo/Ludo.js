import { BASE_POSITIONS, HOME_ENTRANCE, HOME_POSITIONS, PLAYERS, 
    SAFE_POSITIONS, START_POSITIONS, STATE, TURNING_POINTS
 } from './constants.js';
...
export class Ludo {
    ...
    checkForKill(player, piece) {
        ...
        PLAYERS.filter(p => p !== player).forEach(opponent => {
            [0, 1, 2, 3].forEach(piece => {
