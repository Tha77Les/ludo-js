export const COORDINATES_MAP = {
    ...
    50: [7, 14], 51: [6, 14], 52: [5, 14], 53: [4, 14], 54: [3, 14],
    55: [2, 14], 56: [1, 14], 57: [0, 14], 58: [0, 13], 59: [0, 12],
    60: [0, 11], 61: [0, 10], 62: [0, 9],

    // HOME ENTRANCE
    100: [7, 13], 101: [7, 12], 102: [7, 11], 103: [7, 10], 104: [7, 9], 105: [7, 8],
    200: [7, 1], 201: [7, 2], 202: [7, 3], 203: [7, 4], 204: [7, 5], 205: [7, 6],
    300: [8, 7], 301: [9, 7], 302: [10, 7], 303: [11, 7], 304: [12, 7], 305: [13, 7],
    400: [6, 7], 401: [5, 7], 402: [4, 7], 403: [3, 7], 404: [2, 7], 405: [1, 7],

    // BASE POSITIONS
    500: [1.5, 10.58], 501: [3.57, 10.58], 502: [1.5, 12.43], 503: [3.57, 12.43],
    600: [10.5, 1.58], 601: [12.54, 1.58], 602: [10.5, 3.45], 603: [12.54, 3.45],
    700: [10.5, 10.58], 701: [12.54, 10.58], 702: [10.5, 12.43], 703: [12.54, 12.43],
    800: [1.5, 1.58], 801: [3.57, 1.58], 802: [1.5, 3.45], 803: [3.57, 3.45]
};
...
export const TURNING_POINTS = {
    P1: 50, P2: 24, P3: 37, P4: 11
};

export const SAFE_POSITIONS = [0, 8, 13, 21, 26, 34, 39, 47, 52];
